import NumpyNetworkClasses as nc
...
for i in range(3000):
    NeuralNet.BackProp([0],[0])
    NeuralNet.BackProp([0.1],[0.1])
    NeuralNet.BackProp([1],[1])
    NeuralNet.BackProp([0.2],[0.2])
    NeuralNet.BackProp([0.7],[0.7])
    NeuralNet.BackProp([0.3],[0.3])
    NeuralNet.BackProp([0.9],[0.9])
    NeuralNet.BackProp([0.6],[0.6])
    NeuralNet.BackProp([0.8],[0.8])
